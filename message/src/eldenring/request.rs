...
pub enum RequestParams {
    CreateSession(Box<RequestCreateSessionParams>),
    DeleteSession,
    RestoreSession(Box<RequestRestoreSessionParams>),
    DebugCommand,
    ServerPing,
    CheckAlive,
    ...
    UpdateLoginPlayerCharacter(Box<player::RequestUpdateLoginPlayerCharacterParams>),
    ...
    LeaveMultiplay,
    GetMatchDensity(Box<match_density::RequestGetMatchDensityParams>),
    GetPlayZoneIdList,
    ...
    UnregisterQuickMatch(Box<quickmatch::RequestUnregisterQuickMatchParams>),
    UpdateQuickMatch(Box<quickmatch::RequestUpdateQuickMatchParams>),
    JoinQuickMatch(Box<quickmatch::RequestJoinQuickMatchParams>),
    AcceptQuickMatch(Box<quickmatch::RequestAcceptQuickMatchParams>),
    RejectQuickMatch(Box<quickmatch::RequestRejectQuickMatchParams>),
    ...
    PollMatchingTicket(Box<matchingticket::RequestPollMatchingTicketParams>),
    DeleteMatchingTicket(Box<matchingticket::RequestDeleteMatchingTicket>),
    CreateBattleSession(Box<quickmatch::RequestCreateBattleSessionParams>),
...
impl RequestParams {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::UpdateLoginPlayerCharacter(_) => "UpdateLoginPlayerCharacter",
            ...
            Self::GetMatchDensity(_) => "GetMatchDensity",
            ...
            Self::PollMatchingTicket(_) => "PollMatchingTicket",
            Self::DeleteMatchingTicket(_) => "DeleteMatchingTicket",
            Self::CreateBattleSession(_) => "CreateBattleSession",
