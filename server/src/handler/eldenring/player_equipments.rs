use message::eldenring::{RequestGrGetPlayerEquipmentsParams, RequestGrUploadPlayerEquipmentsParams, ResponseGrGetPlayerEquipmentsParams, ResponseGrGetPlayerEquipmentsParamsEntry, ResponseGrUploadPlayerEquipmentsParams};

use crate::handler::HandleRequest;

use super::DefaultClientHandler;

impl HandleRequest<Box<RequestGrUploadPlayerEquipmentsParams>, ResponseGrUploadPlayerEquipmentsParams>
